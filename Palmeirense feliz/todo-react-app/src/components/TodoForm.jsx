...
/**
 * O componente `TodoForm` é responsável por adicionar novas tarefas à lista.
 *
...
export const TodoForm = ({ addTodo }) => {
  // Define um estado local 'value' e uma função 'setValue' para atualizá-lo.
  const [value, setValue] = useState("");

  /**
   * Manipula o envio do formulário, chamando a função 'addTodo' e persistindo a tarefa no LocalStorage.
   *
  ...
  return (
    <form onSubmit={handleSubmit} className="TodoForm">
      <input
        ...
        placeholder="Adicione sua tarefa aqui, Palmeirense!"
      />
